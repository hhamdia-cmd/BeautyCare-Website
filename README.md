#  BeautyCare Website
 ...
 Docker containerization موقع ويب تجاري تفاعلي للعناية بالبشرة مع 
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             # المميزات
                                                                                                                                                                                  - ثلاث صفحات رئيسية (الرئيسية، التسجيل، التواصل)
     RTL تصميم متجاوب باللغة العربية مع دعم- 
...
# How to build and run using Docker  
                                                                                                                                                                                  التأكد من وجود دوكر على جهازك عن طريق  1) 
     [ docker --version]
  ...
  3) Run the container
     [ docker run -d -p 8080:80 --name beautycare-app beautycare-website  ]
   
                                                                                                                                                                                                    التحقق من التشغيل 4)
                                                                                                                                                                                                     # رؤية الحاويات النشطة
            [ docker ps ]
                                                                                                                                                                                                   # رؤية السجلات(logs)                                                                                                                                                                                                         
           [ docker logs skincare-app ]  
 
                                                                                                                                                                                                 فتح الموقع في المتصفح 5)          
...
# Configuration notes:
 * Ports:
    (Container)المنفذ 80  : داخل الحاوية    
    (Host)المنفذ8080 :على المضيف 
                                                                                                                                                                                            ( 8080:80):  التعيين  
...
Production URL:
https://beautycare-website.onrender.com
